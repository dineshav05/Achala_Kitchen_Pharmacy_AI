    ...
    with st.chat_message("assistant"):
        try: # <-- THE OUTER TRY (For the AI API)
            ...
            if uploaded_file is not None:
                ...
                <body style="font-family: Arial, sans-serif; padding: 30px; color: #2b2b2b;">
                    <div style="border: 2px solid #0f4c5c; padding: 30px; border-radius: 8px;">
                        <div style="border-bottom: 2px solid #0f4c5c; padding-bottom: 15px; margin-bottom: 20px;">
                            <h2 style="margin: 0; color: #0f4c5c; font-size: 24px;">Achala Enterprises</h2>
                            <p style="margin: 0; color: #666; font-weight: bold;">Digital Vaidya • Advanced Visual Analysis Report</p>
                        </div>
                        <div style="line-height: 1.6; font-size: 14px;">
                            {ai_response}
                        </div>
                        <div style="margin-top: 40px; border-top: 1px solid #ccc; padding-top: 15px; font-size: 11px; color: #777; text-align: center;">
