    ...
    with st.chat_message("assistant"):
        try: # --- OUTER TRY BLOCK BEGINS ---
            ...
            if uploaded_file is not None:
                ...
                <body style="font-family: Arial, sans-serif; padding: 40px; color: #2b2b2b; background-color: #f9f9f9;">
                    <div style="max-width: 800px; margin: 0 auto; background-color: #ffffff; padding: 40px; border: 2px solid #0f4c5c; border-radius: 8px;">
                        <div style="display: flex; align-items: center; border-bottom: 2px solid #0f4c5c; padding-bottom: 20px; margin-bottom: 30px;">
                            <img src="data:image/png;base64,{fresh_logo_base64}" width="80" style="margin-right: 20px;">
                            <div>
                                <h2 style="margin: 0; color: #0f4c5c; font-size: 26px;">Achala Enterprises</h2>
                                <p style="margin: 0; color: #666; font-weight: bold; font-size: 16px;">Digital Vaidya • Advanced Visual Analysis Report</p>
                            </div>
                        </div>
                        ...
                        <div style="margin-top: 50px; border-top: 1px solid #ccc; padding-top: 20px; font-size: 12px; color: #777; text-align: center;">
                            <b>Guided by the Ayurvedic principles of Shri Rajiv Dixit Ji.</b><br>
                            Disclaimer: This report is generated by AI for educational purposes and holistic wellness.<br>
                            Always consult a qualified medical professional before altering prescribed treatments.
                        </div>
                    </div>
                </body>
                </html>
